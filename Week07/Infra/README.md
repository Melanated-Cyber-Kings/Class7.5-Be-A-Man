<h1>Individual Homework Submissions – Class 7.5_Week07</h1>
<h3 align="center">Delivarables:</h3
Code in a new(On a new GitHub repo "Class7.5-Be-A-Man).
...
WHAT I HAVE DONE:
    1.Created terraform code.
    2.Deployed infrastructure.
    3.Generated deliverables.
    4.Provided relevant screenshots.
    4.Perform teardown of infrastructure and verify all resources have been removed from your GCP project.